...
const REGION_DETAILS = {
    "ホッカイドー": {
        ...
        hint: "岩は削りやすいですが、化石自体がとても大きいです。制限時間に注意して削りましょう。"
    },
    "トウホク": {
    ...
    "チュウブ": {
        ...
        hint: "周囲の岩がたいへん硬いため、道具を強化してから挑戦することをおすすめします。"
    },
    "キンキ": {
        feature: "大昔は湖や川の底だった場所が多く、さまざまな硬さの岩や土が混ざりあっています。",
        hint: "柔らかい場所と硬い場所が混ざっています。岩の色や質感をよく見て、道具を切り替えましょう。"
    },
    "チュウゴク": {
        feature: "大昔のサンゴ礁からできた「石灰岩（せっかいがん）」が多く、水に溶けやすくヒビが入りやすい性質があります。",
        hint: "うまく叩くと、ヒビに沿って岩が大きく割れ、効率よく削ることができます。"
    },
    "シコク": {
        feature: "大地の強い力で押されたことで、パイのように幾重にも層（そう）になっている岩が多く見られます。",
        hint: "岩に「向き」が存在します。正しい方向から削ることで、滑らかに岩を取り除くことができます。"
    },
    "キュウシュー": {
        feature: "多くの火山が存在し、ドロドロの溶岩（ようがん）が固まってできた岩石でおおわれています。",
        hint: "ゴツゴツとした不規則で硬い岩が多いため、細かい作業が得意な「タガネ」を活用しましょう。"
    }
};